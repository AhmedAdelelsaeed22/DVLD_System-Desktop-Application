...
{
    public partial class FrmAddNewVisionTest : MaterialSkin.Controls.MaterialForm
    {
        ...
        public FrmAddNewVisionTest(clsLocalDrivingLicenseApplication LocalDrivingLicenseAppInfo, clsApplication ApplicationInfo)
        {
            InitializeComponent();
        ...
        public FrmAddNewVisionTest(clsLocalDrivingLicenseApplication LocalDrivingLicenseAppInfo
        ...
        public FrmAddNewVisionTest(int ModeNumber,clsLocalDrivingLicenseApplication LocalDrivingLicenseAppInfo,
           clsApplication ApplicationInfo)
            ...
            , clsApplication ApplicationInfo)
        {
            ...
            lblFees.Text = clsApplicationTestType.GetApplicationTestTypeFees(1).ToString(); 
        }
        ...
        private void FrmAddNewVisionTest_Load(object sender, EventArgs e)
        {
            _DataLoad();
        }
