...
{
    public partial class FrmAddStreetTest : MaterialSkin.Controls.MaterialForm
    {
        ...
        public FrmAddStreetTest(clsLocalDrivingLicenseApplication LocalDrivingLicenseAppInfo, clsApplication ApplicationInfo)
        {
            InitializeComponent();
        ...
        public FrmAddStreetTest(clsLocalDrivingLicenseApplication LocalDrivingLicenseAppInfo
        ...
        public FrmAddStreetTest(int ModeNumber, clsLocalDrivingLicenseApplication LocalDrivingLicenseAppInfo,
           clsApplication ApplicationInfo)
        {
            _LocalDrivingLicenseAppInfo = LocalDrivingLicenseAppInfo;
            _ApplicationInfo = ApplicationInfo;
         ...
         , clsApplication ApplicationInfo)
        {
            ...
            lblFees.Text = clsApplicationTestType.GetApplicationTestTypeFees(3).ToString();
        }
        ...
        private void FrmAddStreetTest_Load(object sender, EventArgs e)
        {
            _DataLoad();
        }
