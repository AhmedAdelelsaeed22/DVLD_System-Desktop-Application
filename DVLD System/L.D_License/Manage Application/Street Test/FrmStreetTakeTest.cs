...
{
    public partial class FrmStreetTakeTest : MaterialSkin.Controls.MaterialForm
    {
        ...
        public FrmStreetTakeTest(int TestAppointmentID
        ...
        private void FrmStreetTakeTest_Load(object sender, EventArgs e)
        {
